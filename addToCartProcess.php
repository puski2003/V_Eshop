...
if(isset($_GET["id"])){
    ...
    if($cart_num == 1){
        ...
        if($product_qty >= $new_qty){
            ...
            Database::iud("UPDATE `cart` SET `cart_qty`='".$new_qty."' WHERE `product_id`='".$pid."' AND `user_email`='".$umail."'");
        ...
        Database::iud("INSERT INTO `cart`(`product_id`,`user_email`,`cart_qty`) VALUES ('".$pid."','".$umail."','1')");
