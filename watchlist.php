...
<body>
    ...
    <div class=" bodytop container-fluid ">
        <div class="row">
                                                ...
                                                <div class="card mb-3 mx-0 mx-lg-2 col-12">
                                                    <div class="row g-0">
                                                        <div class="col-md-4">
                                                            ...
                                                            ?>
                                                            <img src="<?php echo $images_data["path"]; ?>" class="img-fluid rounded-start" style="height: 200px;" />
                                                        </div>
                                                        <div class="col-md-5">
                                                            <div class="card-body">
                                                                <?php
                                                                ...
                                                                $clr_rs = Database::search("SELECT * FROM `color` WHERE `color_id`='".$product_data["id"]."'");
