                                    ...
                                    <div class="row">
                                        ...
                                        <div class="offset-lg-3 col-12 col-lg-6">
                                            <div class="row">
                                                ...
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resource/addproductimg.jpeg" class="img-fluid" style="width: 250px;" id="i1"/>
                                                </div>
                                                <div class="col-4 border border-primary rounded">
                                                    <img src="resource/addproductimg.jpeg" class="img-fluid" style="width: 250px;" id="i2"/>
                                                </div>
                                            </div>
                                        </div>
